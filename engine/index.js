...
let LKFPOWERVIEWSENGINELOGINPASS;
let LKFPOWERVIEWSENGINEMONGOURL;

const getconfig = () => {
	({ LKFPOWERVIEWSENGINELOGINUSER, LKFPOWERVIEWSENGINELOGINPASS, LKFPOWERVIEWSENGINEMONGOURL } = process.env);
	if (!LKFPOWERVIEWSENGINELOGINUSER || !LKFPOWERVIEWSENGINELOGINPASS || !LKFPOWERVIEWSENGINEMONGOURL)
		throw 'error LKFPOWERVIEWSENGINELOGINUSER, LKFPOWERVIEWSENGINELOGINPASS and LKFPOWERVIEWSENGINEMONGOURL variables required in engine environment'
}
...
const dologin = async () => {
	const body = {
		...
		password: LKFPOWERVIEWSENGINELOGINPASS
	};
